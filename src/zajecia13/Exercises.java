...
import zajecia13.generator.AccountGenerator;
import zajecia13.generator.HoldingGenerator;
import zajecia13.model.Account;
import zajecia13.model.Company;
import zajecia13.model.Holding;
import zajecia13.model.User;
...
public class Exercises {
    ...
    public static void main(String[] args) {
      ...
      //  System.out.println(getAccountAmountInPLN()));
    ...
    public static List<String> getHoldingNames() {
        return holdings.stream()
                .map(holding -> holding.getName().toUpperCase(Locale.ROOT))
                .toList();
    ...
    public static long getCompaniesAmount() {
        return holdings.stream()
                .mapToInt(holdings -> holdings.getCompanies().size())
                .sum();
    ...
    /**
     * Zwraca listę wszystkich nazw firm jako listę, której implementacja to LinkedList. Obiektów nie przepisujemy
